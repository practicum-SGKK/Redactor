...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"им€ файла дл€ загрузки строк";
			// 
			// radioButton1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		{
			System::IO::StreamReader^ sr = gcnew System::IO::StreamReader("C:\\Users\\ сени€\\Desktop\\menu1\\text2.txt"); //здесь указываем любой путь
